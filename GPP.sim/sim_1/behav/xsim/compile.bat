...
REM
REM Generated by Vivado on Wed May 27 14:07:43 -0400 2026
...
echo "xvlog --incr --relax -prj gppFile3_tb_vlog.prj"
call xvlog  --incr --relax -prj gppFile3_tb_vlog.prj -log xvlog.log
