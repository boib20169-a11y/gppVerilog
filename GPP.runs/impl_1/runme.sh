...
HD_PWD='C:/Summer/vivadoStuff/gppVerilog-main/gppVerilog-main/GPP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gppFileMultiplexed3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gppFileMultiplexed3.tcl -notrace
