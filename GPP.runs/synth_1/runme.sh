...
HD_PWD='C:/Summer/vivadoStuff/gppVerilog-main/gppVerilog-main/GPP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gppFileMultiplexed3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gppFileMultiplexed3.tcl
